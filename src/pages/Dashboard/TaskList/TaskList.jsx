            ...
            {filteredTasks.length > paginatedTasks.length && (
                <div className="flex justify-center space-x-12 mt-4 ">
                    <button
                        ...
                        className="px-4 py-2 bg-blue-500 text-white rounded-full md:rounded-lg hover:bg-blue-600 transition-colors"
                    >
                        Anterior
                    </button>
                    ...
                    <button
                        ...
                        className="px-4 py-2 z-20 bg-blue-500 text-white rounded-full md:rounded-lg hover:bg-blue-600 transition-colors"
                    >
                        Siguiente
                    </button>
                </div>
