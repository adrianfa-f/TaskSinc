...
import { FiArrowLeft,FiUploadCloud, FiPaperclip, FiMapPin, FiSave } from 'react-icons/fi';
...
const TaskDetail = () => {
    ...
    useEffect(() => {
        const fetchTask = async () => {
            try {
                ...
                const attachmentsData = await AttachmentService.getAttachmentsByTask(
                    currentUser.uid,
                    taskId
                );
    ...
    return (
        <div className={`p-4 md:p-6 max-w-7xl mx-auto h-[calc(100vh-100px)] overflow-y-auto ${isHidden?"fixed top-0":""}`}>
            <button
                onClick={() => navigate(-1)}
                    ...
                    <div className="space-y-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                className="w-full p-2 border rounded-md h-auto focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center mb-4">
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-gray-600">
                                            {uploading ? 'Subiendo...' : 'Haz clic para agregar archivos'}
                                        </p>
                                    </label>
                                </div>
